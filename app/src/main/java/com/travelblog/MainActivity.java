...
public class MainActivity extends AppCompatActivity
{
    ...
    private static final int SORT_TITLE=0,SORT_DATE=1;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbar.setOnMenuItemClickListener(item->{
            if(item.getItemId()==R.id.sort) onSortClicked();
            return false;
        });
    ...
    {
        if(currentSort==SORT_TITLE) adapter.sortByTitle();
        else if(currentSort==SORT_DATE) adapter.sortByDate();
    }
